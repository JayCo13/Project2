    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                ...
                <div class="icon">
                <p class="ti-location-pin"><ul></ul></p>
                <br>
                <p class="ti-email"><ul> DealZone.com</ul></p>
                <br>

                <p class="ti-time"><ul>MON-SAT: 11AM-6PM<br>SUN: 12-5PM</ul></p>
                </div>
                ...
                <div class="social">
                <a href=""><p class="ti-instagram"></p></a>
                <a href=""><p class="ti-facebook"></p></a>
                <a href=""><p class="ti-twitter"></p></a>
                </div>
            </div>
